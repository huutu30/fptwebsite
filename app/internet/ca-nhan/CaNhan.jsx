...
import { ShieldCheck, Wifi, Activity, MonitorPlay, CheckCircle, ChevronDown, ChevronUp, Download, Upload, Monitor } from 'lucide-react';
        ...
        <section className={styles.section} style={{ paddingTop: '0' }}>
          <div className={`${styles.seoContent} ${showMore ? styles.expanded : styles.collapsed}`}>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-07-10/1752163539_lap-internet-wifi-fpt.jpg" alt="Gói cước Internet cá nhân FPT đi kèm modem Wi-Fi 6" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-07-10/1752120878_lap-wifi-internet-fpt.jpg" alt="Đội ngũ tư vấn FPT hỗ trợ khách hàng" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298415_goi-cuoc-lap-dat-mang-fpt-1.jpg" alt="Gói cước Internet cá nhân FPT với Wi-Fi 6" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298388_goi-cuoc-lap-dat-mang-fpt-3.jpg" alt="Ngoài các gói Internet cá nhân, FPT còn cung cấp thêm gói combo truyền hình" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
