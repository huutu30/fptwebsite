        ...
        <div className="container">
          <div className={`${styles.seoContent} ${showMore ? styles.expanded : styles.collapsed}`}>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298939_internet-doanh-nghiep-3.jpg" alt="FPT Internet cáp quang cho doanh nghiệp" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298972_internet-doanh-nghiep-2.jpg" alt="FPT Internet cho doanh nghiệp Việt" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298989_internet-doanh-nghiep-1.jpg" alt="Wi-Fi 6 FPT cho doanh nghiệp" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
