...
import { Wifi, Zap, Clock, Gift, MonitorPlay, Home as HomeIcon, Camera, ChevronDown, ChevronUp, CheckCircle, Monitor } from 'lucide-react';
...
const TABS = [
  { id: 'internet', label: 'Internet Gia Đình', icon: <HomeIcon size={18} /> },
        ...
        <section className={styles.section} style={{ paddingTop: '0' }}>
          <div className={`${styles.seoContent} ${showMore ? styles.expanded : styles.collapsed}`}>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298777_internet-gia-dinh-2.jpg" alt="FPT tư vấn Internet cho gia đình" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298818_internet-gia-dinh-1.jpg" alt="Chọn FPT cho trải nghiệm Internet ưu việt" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298846_internet-gia-dinh.jpeg" alt="Wi-Fi 6 FPT cho gia đình" style={{ display: 'inline-block', maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
