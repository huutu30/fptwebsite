        ...
        <div className="container">
          <div className={`${styles.seoContent} ${showMore ? styles.expanded : styles.collapsed}`}>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298599_internet-game-thu-2.jpg" alt="Internet FPT cho game thủ và streamer" style={{ maxWidth: '100%', borderRadius: '12px' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-06-30/1751298631_internet-game-thu-.jpg" alt="Công nghệ Ultra Fast FPT" style={{ maxWidth: '100%', borderRadius: '12px' }} />
