  ...
  const smarthomeProducts = [
    {
      ...
      price: 346500,
      image: "https://hi-static.fpt.vn/sys/shop/prod/2025-07-15/687577bbbb186_2.jpg", // Mocked URL
                ...
                <div className={styles.productImgWrap}>
                  <img
                    ...
                    onError={(e) => {
                        ...
                        e.target.src = "https://s3-api.fpt.vn/fptvn-storage/images/product-camera.png"; // Fallback image
                    }}
                  />
                </div>
