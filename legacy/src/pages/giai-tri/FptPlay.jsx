        ...
        <div className="container">
          <div className={`${styles.seoContent} ${showMore ? styles.expanded : styles.collapsed}`}>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102221_fpt-play-cung-day-du-cac-kenh-truyen-hinh-pho-bien-tai-viet-nam.jpg" alt="FPT Play cung cấp đầy đủ các kênh truyền hình phổ biến tại Việt Nam" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102264_de-dang-xem-lai-cac-kenh-hinh-yeu-thich-tren-fpt-play.jpg" alt="Dễ dàng xem lại các kênh hình yêu thích trên FPT Play" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102281_cha-me-co-the-thiet-lap-va-quan-ly-kenh-phu-hop-cho-tre-nho.jpg" alt="Cha mẹ có thể thiết lập và quản lý kênh phù hợp cho trẻ nhỏ" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <p className={styles.seoText}>Sau đây là bảng giá của một số gói cước được yêu thích tại FPT.</p>
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102340_xem-phim-sac-net-am-thanh-song-dong-cung-fpt-play.jpg" alt="Xem phim sắc nét, âm thanh sống động cùng FPT Play" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <p className={styles.seoText}>Đây là một trong những điểm mạnh vượt trội và thu hút nhất của FPT Play. FPT Play là đơn vị sở hữu bản quyền phát sóng độc quyền nhiều giải đấu thể thao hàng đầu ở trong nước và thế giới: Ngoại hạng Anh, FIFA Club World Cup, Champions League, V.League, Asian Cup, bóng rổ Nhà nghề Mỹ, võ thuật PFL, Combate Global, Bellator MMA,...</p>

            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102380_fpt-play-phat-song-doc-quyen-nhieu-giai-dau-the-thao-hang-dau-the-gioi.jpg" alt="FPT Play phát sóng độc quyền nhiều giải đấu thể thao hàng đầu thế giới" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102407_fpt-play-cho-phep-nguoi-dung-truy-cap-tren-nhieu-thiet-bi-khac-nhau.jpg" alt="FPT Play cho phép người dùng truy cập trên nhiều thiết bị khác nhau" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
            ...
            <figure style={{ margin: '30px 0', textAlign: 'center' }}>
              <img src="https://s3-api.fpt.vn/fptvn-storage/2025-08-13/1755102466_cach-dang-ky-truyen-hinh-fpt-play-tren-app-hi-fpt.jpg" alt="Cách đăng ký truyền hình FPT Play trên app Hi-FPT" style={{ maxWidth: '100%', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
