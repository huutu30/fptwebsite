        ...
        <div className={styles.footerMain}>
          ...
          <div className={styles.footerCol}>
            ...
            <ul className={styles.footerLinks}>
              <li><Link href="/gioi-thieu">Giới thiệu chung</Link></li>
              <li><Link href="/lien-ket-thanh-vien">Liên kết - Thành viên</Link></li>
              <li><Link href="/khach-hang-doi-tac">Khách hàng - Đối tác</Link></li>
              <li><Link href="/tap-doan-fpt">Tập đoàn FPT</Link></li>
